  ...
  <div class="home">
    <div class="profile-header">
      <div class="head-avatar">
        <img
          src="https://pbs.twimg.com/profile_images/1346076211521449991/CAIzJaNA_400x400.jpg"
          alt="avatar"
          width="180px"
          height="180px"
        />
      ...
      <div class="head-profile-detail">
        <div class="detail-name">
          <div class="detail-name-username">
            <CustomText class="thin" size="xxlarge">JobsWire</CustomText>
          </div>
        ...
        <div class="detail-numbers">
          <div class="number-1">
            <CustomText tag="b" size="xlarge">20 </CustomText>
            <CustomText size="xlarge">posts</CustomText>
          </div>
          <div class="number-1">
            <CustomText tag="b" size="xlarge">10k </CustomText>
            <CustomText size="xlarge">followers</CustomText>
          </div>
          <div class="number-1">
            <CustomText tag="b" size="xlarge">1 </CustomText>
